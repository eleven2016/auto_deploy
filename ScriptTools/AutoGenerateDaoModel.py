...
def createDao(collection,dao_path,model_name,model_package):
    ...
    for delete_element in delete_elements:
        ...
        content.append("    public int " + id + " ("+parameter+" id);")
        content.append("\n")
        content.append("\n")
    ...
    for update_element in update_elements:
        ...
        content.append("    public int " + id + " (" + parameter_temp + " param);")
        content.append("\n")
        content.append("\n")
    ...
    for select_element in select_elements:
        ...
        parameter_arr = parameter.split(".")
        parameter_temp = parameter_arr[len(parameter_arr) - 1]
        content.append("    public List<"+parameter_temp+"> " + id + "(" + parameter_temp + " param);")
        content.append("\n")
        content.append("\n")
