...
if __name__ == '__main__':
    ...
    dto文件路径
    '''
    dtoFilePath ="D:/workspace_idea/LongManagePlatform/src/main/java/com/eleven/manage/platform/dto/UserDTO.java"
    attributeParams = []
    dtoName = ""
    ...
    print("public static "+dtoName+" DTO2DO("+dtoName[:-2]+"DTO input){");
    print("if (null!=dto){");
